...
!(function (a) {
  ...
  function m(a, b, c) {
    ...
    return a.data("ui-timepicker-value") != b
      ? (a.data("ui-timepicker-value", b),
        ...
        !0)
      : (["error", "initial"].indexOf(c) == -1 && a.trigger("selectTime"), !1);
  }
  function n(a) {
    switch (a.keyCode) {
      case 13:
  ...
  function o(c) {
    ...
    if (!e || !b(e)) {
      ...
      x.show.call(d.get(0)), (e = d.data("timepicker-list")), h(d) || d.focus();
    }
    switch (c.keyCode) {
      case 13:
        return (
          q(d) && (k.call(d.get(0), { type: "change" }), x.hide.apply(this)),
          c.preventDefault(),
          !1
        );
      case 38:
  ...
  function q(a) {
    ...
    return (
      ...
      null !== d && ("string" != typeof d && (d = s(d, b)), m(a, d, "select")),
      !0)
    );
  }
  function r(a, b) {
        ...
        return this.each(function () {
          ...
          if (
            ...
            if ((e.prop("autocomplete", "off"), h.showOn))
              for (var i in h.showOn) e.on(h.showOn[i] + ".timepicker", x.show);
      ...
      show: function (c) {
        ...
        if (
          ...
          e.data("ui-timepicker-value", e.val()),
            j(e, k),
            x.hide(),
            "number" == typeof f.listWidth &&
              (console.log(f.listWidth), k.width(e.outerWidth() * f.listWidth)),
            k.show();
          var m = {};
          f.orientation.match(/r/)
            ...
            : f.orientation.match(/l/)
            ? (m.left =
                e.offset().left +
                parseInt(k.css("marginLeft").replace("px", ""), 10))
            : f.orientation.match(/c/) &&
              (m.left =
                e.offset().left +
                (e.outerWidth() - k.outerWidth()) / 2 +
                parseInt(k.css("marginLeft").replace("px", ""), 10));
          var n;
    ...
    return this.length
      ? x[b]
        ? this.hasClass("ui-timepicker-input")
          ? x[b].apply(this, Array.prototype.slice.call(arguments, 1))
          : this
        : "object" != typeof b && b
